package com.xreactnative.envconfig;
...
public class XRNEnvConfigModule extends ReactContextBaseJavaModule {

    private final ReactApplicationContext reactContext;

    public XRNEnvConfigModule(ReactApplicationContext reactContext) {
        super(reactContext);
